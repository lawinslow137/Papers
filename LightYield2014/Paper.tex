...
\caption[]{PLOT NEEDS TO BE UPDATED!! Charge spectrum for toluene with 5~g/l of PPO. To compare different scintillators the charge at a characteristic point close to the true Compton edge is determined. \label{ChargeSpec_fig}}
 \end{center}
\end{figure}
...
As clearly stated in Table \ref{Toluene_ChargeResults_fig}, toluene produces the highest light yield around 3.2~g/L. Since all of the QDs are dissolved in a toluene solution, and maximizing light yield a main objective, the QD scintillators are doped with 2~g/L PPO for comparison with 2~g/L PPO in toluene. The light yield as a function of QD emission wavelength is plotted in Figure \ref{ly_QD}.

\begin{table}
\caption{Listed below are the fit results for each solvent's data set. The fit parameters and their errors are given and their respective $\chi^{2}$/dof values, and the probabilities to get a worse $\chi^{2}$/dof than the observed one. Since we have 6 data points and 3 parameters in the fit the number of degrees of freedom (dof) is 3. \label{fitresult_table}}
  \begin{center}
    \begin{tabular}{lllllll}
       Solvent & $p_1$ [a.u.] & $p_2$ [g/L] & $p_3$ [g/L] & $\chi^{2}$/dof & prob. & max. LY\\
       \hline\hline\\[-5px]
       Toluene  & $651 \pm 19$  & $0.14 \pm 0.03$  & $0.013 \pm 0.002$ & n/a & n/a & 599 (at 3.2~g/L)\\
       PC & 578 $\pm$ 47  & 2.09 $\pm$ 0.37  & 0.014 $\pm$ 0.004  & n/a  & n/a  & 422 (at 12.2~g/L)\\
       LAB & 525 $\pm$ 24  & 0.36 $\pm$ 0.01  & 0.013 $\pm$ 0.003  & n/a  & n/a & 462 (at 5.3~g/L)\\
       PXE & 694 $\pm$ 25  & 0.48 $\pm$ 0.96  & 0.013 $\pm$ 0.002 & n/a  & n/a & 596 (at 6.1~g/L) \\
       DIN & 668 $\pm$ 19  & 0.27 $\pm$ 0.01  & 0.007 $\pm$ 0.001  & n/a  & n/a & 613 (at 6.2~g/L)  \\
       DIN HP & 673 $\pm$ 40 & 0.19 $\pm$ 0.08 & 0.005 $\pm$ 0.003  & n/a  & n/a & 631 (at 6.1~g/L) \\
       PCH & 634 $\pm$ 29  & 0.34 $\pm$ 0.07  & 0.012 $\pm$ 0.003 & n/a  & n/a & 562 (at 5.4 ~g/L) \\
      \hline \hline
    \end{tabular}
  \end{center}
\end{table}
...
\begin{figure}[tbh]
        \begin{center}
        \subfigure[Toluene]{\includegraphics[scale=0.30]{graphs/Light_Yield/Toluene_Light_Yield.png}}
