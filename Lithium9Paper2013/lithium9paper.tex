...
\begin{figure}[t]
  ...
  \includegraphics[scale=0.65]{HelliumDecayScheme.pdf}
  \label{he8_diagram}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{tabular}{cc}
    \includegraphics[width=70mm]{a_n_beta_spect_c1_8He.pdf}&

    \includegraphics[width=70mm]{a_n_beta_spect_c2_8He.pdf}\\
    \includegraphics[width=70mm]{a_n_beta_spect_c3_8He.pdf}&

    \includegraphics[width=70mm]{a_n_beta_spect_c4_8He.pdf}\\
    
    \includegraphics[width=70mm]{a_n_beta_spect_c5_8He.pdf}&
    
      \includegraphics[width=70mm]{a_n_beta_spect_c6_8He.pdf}\\
